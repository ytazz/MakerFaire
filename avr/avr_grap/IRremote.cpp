...
//+=============================================================================
#define IR_RECEIVE_SIGNAL (_SFR_BYTE(PINE)&_BV(6))	// GPIO connected to IR data from detector
#define IR_RECEIVE_BLINK_ON sbi(PORTC,7)
#define IR_RECEIVE_BLINK_OFF cbi(PORTC,7)
#define IR_RECEIVE_BLINK_FLAG 1		// 1 -> enable blinking of pin on IR processing
...
{
	DBG_PRINT("Testing: %d <= %d <= %d", TICKS_LOW(desired), measured, TICKS_HIGH(desired));
